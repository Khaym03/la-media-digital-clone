...
export default function AdvantageList() {
  return (
    <section className="flex flex-col justify-center items-center w-full container py-20">
      <H2>¿Lo necesitas? nosotros lo tenemos.</H2>
      <p className='text-center text-balance text-lg text-black/60 max-w-[1000px] mt-4'>En la agencia de Marketing La Media Digital impulsamos tu marca con soluciones creativas y efectivas. Manejo de redes sociales, identidad corporativa, jingles comerciales y más. Potencia tu presencia en el mundo digital con nosotros.</p>
